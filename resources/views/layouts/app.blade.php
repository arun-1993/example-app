...
<body>
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 bg-white border-bottom shadow-sm mb-3">
        ...
        <nav class="my-2 my-md-0 mr-md-3">
            ...
            <a href="{{ route('post.index') }}" class="p-2 text-dark">Blog Posts</a>
            <a href="{{ route('post.create') }}" class="p-2 text-dark">Add Blog Posts</a>
            |
            @guest
    ...
    <div class="container">
        @if (session('status'))
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Success:"><use xlink:href="#check-circle-fill"/></svg> {{ session('status') }}
